...
### 2025
1. Youan Cong, Cheng Wang, **Pritom Saha Akash** and Kevin Chen-Chuan Chang. Query Optimization for Parametric Knowledge Refinement in Retrieval-Augmented Large Language Models. Findings of the 2025 Conference on Empirical Methods in Natural Language Processing **(EMNLP Findings)**. 2025.
...
5. **Pritom Saha Akash**, Kevin Chen-Chuan Chang. Extract Class Refactoring Recommendations using Variational Graph Auto-Encoders. arXiv preprint arXiv:2203.08787 (2021). [[pdf](https://arxiv.org/pdf/2203.08787.pdf)]
...
3. **Pritom Saha Akash**, Md. Eusha Kadir, Amin Ahsan Ali, Md. Nurul Ahad Tawhid and Mohammad Shoyaib. Introducing Confidence as a Weight in Random Forest. 2019 International Conference on Robotics, Electrical and Signal Processing Techniques (ICREST).   
