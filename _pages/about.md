...
My research interests are mainly in **Text Mining** & **Natural Language Processing (mostly in LLM)**, including Information Extraction, Selection, and Summarization, with a recent interest in **Recommender Systems**.
